    ...
    if(this!=NULL && nodeIndex >= 0 && nodeIndex <= ll_len(this))
    {
    	...
    	if(nuevoNodo!=NULL)
    	{
    		if(nodeIndex == 0)
    		{
    			...
    			nodoActual = getNode(this, (nodeIndex -1 ));
    			if(nodoActual!=NULL)
    			{
					nuevoNodo->pNextNode = nodoActual->pNextNode;
					nodoActual->pNextNode = nuevoNodo;
					nuevoNodo->pElement = pElement;
					this->size++;
					returnAux = 0;
    			}
    ...
    if(this!=NULL && index >=0 && index < ll_len(this)){
    	...
    	if(auxNode != NULL){
    		if(index == 0){
    			...
    			if(nodoAnt != NULL){
    				nodoAnt->pNextNode = auxNode->pNextNode;
    				returnAux = 0;
    			}
    		}
    		if(returnAux==0){
    ...
    if(this!=NULL && (order == 1 || order == 0) && pFunc != NULL)
    {
    	for(int i = 0 ; i<ll_len(this) -1 ; i++)
    	{
    		for(int j = i + 1; j < ll_len(this); j++)
    		{
    			aux1 = ll_get(this,i);
    			aux2 = ll_get(this,j);
    			if(((pFunc((aux1),(aux2))>0) && order == 1) || ((pFunc((aux1), (aux2))< 0) && order == 0))
				{
    				ll_set(this,j,aux1);
    				ll_set(this,i,aux2);
    			}
